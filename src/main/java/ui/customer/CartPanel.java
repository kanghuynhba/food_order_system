...
public class CartPanel extends JPanel {
    ...
    public CartPanel(CustomerMainFrame parentFrame) {
    ...
    private JPanel createButtonsPanel() {
        ...
        checkoutBtn.addActionListener(e -> parentFrame.proceedToCheckout());
        ...
        clearBtn.addActionListener(e -> parentFrame.clearCart());
    ...
    public void refreshCart() {
        ...
        List<CartItem> items = parentFrame.getCartItems();
        ...
        if (items.isEmpty()) {
            ...
            for (CartItem item : items) {
                ...
                row.getQuantitySpinner().addChangeListener(e -> {
                    ...
                    parentFrame.updateCartItemQuantity(item, newQty);
                });
                
                // Remove button listener
                row.getRemoveButton().addActionListener(e -> {
                    parentFrame.removeFromCart(item);
                });
    ...
    private void updateSummary() {
        double subtotal = parentFrame.getCartTotal();
        double tax = parentFrame.getCartTax();
        double discount = parentFrame.getCartDiscount();
        double total = parentFrame.getCartGrandTotal();
        ...
        checkoutBtn.setEnabled(!parentFrame.getCartItems().isEmpty());
    }
}